...
cv2.imwrite(os.path.join(OUT, 'mode_west_bg.jpg'), bg, [cv2.IMWRITE_JPEG_QUALITY, 82])
...
cv2.imwrite(os.path.join(OUT, 'mode_samurai_bg.jpg'), bg, [cv2.IMWRITE_JPEG_QUALITY, 82])
